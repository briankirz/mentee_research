...
def calc_alpha(A, B, pi, Ob, N, T):
    ...
    INPUT:
        ...
        - Ob, a string representing the observed sequence (numbers indexed to labels)
    ...
    for t in range(1, T + 1):
        ...
        for j in range(N):
            ...
            for i in range(N):
                ...
                # + likelihood it transitioned from that state i to this state j using the transition matrix A
                # + the likelihood that state i emitted this observed character j using the emission matrix B
